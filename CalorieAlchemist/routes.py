...
from CalorieAlchemist import app, db, bcrypt
from CalorieAlchemist.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
...
def save_image(form_picture):
    ...
    _, f_ext = os.path.splitext(form_picture.filename)
    picture_fn = random_hex + f_ext
    picture_path = os.path.join(app.root_path, r'static\images', picture_fn)
